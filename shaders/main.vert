...
out Varyings { // Note: the name "Varying" this line is something we decided. We can use any name as long as the fragment shader uses the same name for this block.
    vec4 color;
} vs_out;
